...
const CampaignDetail = () => {
  ...
  const [realSold, setRealSold] = useState<number | null>(null);
  ...
  useEffect(() => {
    ...
    ticketsAPI.getStatus(id)
      .then((data) => {
        if (data?.sold_count !== undefined) setRealSold(data.sold_count);
        if (data?.total_numbers !== undefined) setRealTotal(parseInt(data.total_numbers));
      })
      .catch(() => {})
  ...
  const soldTickets = realSold ?? campaign.soldTickets;
  const totalTickets = realTotal ?? campaign.totalTickets;
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 py-4 border-y border-border">
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg font-bold">{formatNumber(soldTickets)}</p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {formatNumber(soldTickets)} de {formatNumber(totalTickets)} cotas vendidas
                  {!isDisabled && (
                    <span className="ml-2">
